        ...
        if (isDevMode) {
          ...
          if (match && isMounted) {
            ...
            setFormState({
              ...
              vatRate: typeof match.vatRate === "number" ? match.vatRate : Number(match.vatRate || 25),
          ...
          if (isMounted) {
            ...
            setFormState({
              ...
              vatRate: typeof response.vatRate === "number" ? response.vatRate : Number(response.vatRate || 25),
